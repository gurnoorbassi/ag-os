...
if (!["v1.2", "v1.3 draft PR", "v1.3", "v1.4 draft PR", "v1.4 reviewed PR"].includes(data.socialMediaSystem.currentVersion)) {
...
if (["v1.4 draft PR", "v1.4 reviewed PR"].includes(data.socialMediaSystem.currentVersion) &&
